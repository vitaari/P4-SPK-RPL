...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 02 Mar 2024 pada 05.34
...
(5, '2023_11_07_021832_create_kategoris_table', 1),
(6, '2023_11_07_060536_create_produks_table', 1),
(7, '2023_11_09_002911_create_transaksis_table', 1),
(8, '2023_11_10_014053_create_transaksi_details_table', 1),
(9, '2024_01_23_132901_create_pelanggans_table', 1),
(10, '2024_03_01_005129_delete_relation', 1);
...
CREATE TABLE `transaksis` (
  ...
  `status` enum('selesai','pending','belum bayar') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
(1, 'Admin', 'admin@gmail.com', NULL, '$2y$10$xvyzE5ke2k7/pJGlljhMvOnJDzV9gfeNSx/C3hNaOuEiDPFRrqYGG', 'admin', NULL, '2024-03-01 21:13:02', '2024-03-01 21:13:02'),
(2, 'Petugas', 'petugas@gmail.com', NULL, '$2y$10$BW1h2YVqz5P5EmmW4QBUI.69WOlSqK7a5OmIGoUoujo5bl3JLDNM.', 'petugas', NULL, '2024-03-01 21:13:02', '2024-03-01 21:13:02');
